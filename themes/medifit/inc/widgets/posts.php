				...
				foreach($posts as $p) {?>
                    <li>
						...
						<?php if ( ($instance['display_date']) ) { ?>
							<span class='date'><?php echo get_the_time('M j, Y',$p->ID); ?></span>
						<?php } ?>
						
						<?php if ( $instance['display_content'] ) { ?> 
							<?php echo "<p>".strip_tags(smtheme_excerpt('maxchar='.$instance['excerpt_length'], $p->ID),'<strong><b><i><p><abbr><acronim><cite><q><strike>')."</p>"; ?>
						<?php } ?>
